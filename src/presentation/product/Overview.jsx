          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex 2xs:justify-between sm:justify-end items-center">
              ...
              <div className='flex justify-center items-center' >
                <Button className="rounded-full w-10 h-10 bg-indigo-500 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4" >
                  <Icon className="w-6 h-6 text-bold text-white" type="cart" />
                </Button>
