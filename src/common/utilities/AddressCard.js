...
const AddressCard = ({ addresses, ...props }) => {
    return (
        <div {...props}>
            {addresses?.map(({id, isDefaultShipping, shipping_name, ...data}) => <div key={id} className="p-4 cursor-pointer 2xs:mx-auto lg:ml-0 lg:mr-auto w-full sm:w-[80%] xs:w-[100%] md:w-[450px]" >
