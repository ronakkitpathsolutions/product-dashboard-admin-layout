            ...
            <div className='mx-2' >
                <div className="mt-4 flex justify-between">
                    ...
                    <div className='flex items-center justify-evenly' >
                        {wishlists[id] ? <SolidIcon onClick={() => addToWishList(id)} className="w-6 h-6 text-bold text-red-500" type="heart" /> : 
                        <Icon onClick={() => addToWishList(id)} className="w-6 h-6 text-bold text-red-500" type="heart" />}
                    </div>
                </div>
