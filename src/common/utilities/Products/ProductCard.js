    ...
    return (
        <div>
            <div onClick={() => productOverview(_id)} className="cursor-pointer relative aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-[25rem]">
                <span className="bg-green-500 2xs:px-2 2xs:py-[0.2rem] text-white md:px-3 md:py-1 tracking-widest text-[0.5rem] md:text-xs absolute right-0 top-0 rounded-bl">{nett_percentage}% off</span>
            ...
            <div>
                ...
                <div className='flex justify-between' >
                    ...
                    <div className='flex flex-col justfy-end items-end'>
                        <p className="mt-1 line-through text-gray-500 2xs:text-[0.6rem] ml-[6px] md:text-[0.8rem] font-medium">₹{convetRuppesFormat(price + Math.round(percentage) || 1)}</p>
